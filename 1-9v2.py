...
Prejudge(1,10)
WriteZombies([0,0,0,0,0,1,2,3],[2,2,2,2,2,2,2,4])
...
Prejudge(1,13)
WriteZombies([0,4],[4,4])
use_shovel(2,9)
PlantWhenAvailable(3,150,(2,9))

Prejudge(1,14)
WriteZombies([0,4],[4,3])

Prejudge(1,15)
WriteZombies([0,4],[1,1])
Delay(425)
PlantWhenAvailable(3,150,(1,9))

Prejudge(1,16)
WriteZombies([2,4],[4,5])
PlantWhenAvailable(4,50,(4,1))
Delay(425)
use_shovel(4,1)
use_shovel(5,9)
PlantWhenAvailable(3,150,(5,9))
...
Prejudge(1,18)
WriteZombies([2,4],[3,1])
use_shovel(3,9)
PlantWhenAvailable(3,150,(3,9))

Prejudge(1,19)
WriteZombies([0,2,4],[2,3,5])
use_shovel(3,9)
PlantWhenAvailable(3,150,(3,9))
Delay(200)
use_shovel(3,9)
...
Prejudge(1,20)
WriteZombies([0,0,0,0,0,0,0,0,1,2,3,4],[2,3,4,2,3,4,2,3,4,2,3,4])
Delay(215)
