...
refresh_trigger = [750 if wave % 10 == 0 else 599 if wave == 1 else 200 for wave in range(1, 41)]
...
item_type_names = {1: "银币", 2: "金币", 3: "钻石", 4: "阳光", 5: "小阳光", 6: "大阳光", 7:7, 8:8, 9:9,10:10,11:11,12:12,13:13,14:14,15:15, 16:16, 17: "幼苗",18:18,19:19,20:20,21:21,22:22,23:23,24:24,25:25,26:26}
...
def auto_collect(collect_items=None, interval_cs=12):
    ...
    while game_ui() == 3:
        ...
        for i in range(items_count_max):
            ...
            if not disappeared and not collected:
