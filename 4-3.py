...
waves[200:202] = [0,0,-1]
waves[250:252] = [0,0,-1]
waves[300:302] = [0,16,-1]
waves[350:353] = [0,0,0,-1]
waves[400:403] = [0,0,0,-1]
waves[450:458] = [0,0,0,0,0,1,2,16,-1]
waves = tuple(waves)
while(game_ui() != 3):
    Sleep(1)
update_game_scene()
...
Prejudge(0,7)
WriteZombies([0,16],[1,2],[0.37,0.37])

Prejudge(0,8)
WriteZombies([0,0,0],[1,2,3],[0.37,0.37,0.37])
PlantWhenAvailable(2,0,(2,9))
...
Prejudge(1,10)
WriteZombies([0,0,0,0,0,1,2,16],[1,2,3,4,4,5,5,1])
