...
PlantWhenAvailable(2,50,(3,6))
Delay(200)
use_shovel(3,1)
PlantWhenAvailable(5,25,(5,9))

Prejudge(0,10)
WriteZombies([0,0,0,0,0,1,2,3],[3,3,3,3,3,1,3,5])
PlantWhenAvailable(1,100,(2,8))
PlantWhenAvailable(2,50,(3,2))

Prejudge(0,11)
WriteZombies([0,0,3],[1,2,4])
PlantWhenAvailable(1,100,(2,7))

Prejudge(0,12)
WriteZombies([0,0,3],[1,2,4])
PlantWhenAvailable(2,50,(4,4))

Prejudge(0,13)
WriteZombies([0,2,2],[5,5,5])
PlantWhenAvailable(1,100,(2,5))

Prejudge(0,14)
WriteZombies([0,0,0,3],[1,2,3,5])
PlantWhenAvailable(5,25,(4,9))
PlantWhenAvailable(1,100,(3,7))

Prejudge(0,15)
WriteZombies([0,2,2],[4,4,4])
PlantWhenAvailable(4,50,(5,1))
PlantWhenAvailable(1,100,(3,5))

Prejudge(0,16)
WriteZombies([0,0,0,0,3],[1,2,2,3,5])
PlantWhenAvailable(1,100,(1,5))
PlantWhenAvailable(2,50,(5,2))

Prejudge(0,17)
WriteZombies([0,0,0,0,3],[1,1,2,3,5])
PlantWhenAvailable(1,100,(3,9))
use_shovel(5,1)

Prejudge(0,18)
WriteZombies([2,2,2],[5,5,5])

Prejudge(0,19)
WriteZombies([0,2,2,2],[4,4,4,4])
