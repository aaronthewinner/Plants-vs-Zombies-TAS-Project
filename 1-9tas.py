...
update_game_scene()
Sleep(350)
select_seeds_and_lets_rock((0,1,2,4,6,5))
...
PlantWhenAvailable(4,25,(1,9))
Prejudge(1,9)
WriteZombies([2,0],[2,2])
PlantWhenAvailable(2,50,(3,3))
PlantWhenAvailable(2,50,(3,4))
Prejudge(1,10)
WriteZombies([0,0,0,0,0,1,4],[4,4,4,4,4,5,5])
Prejudge(1,11)
WriteZombies([4],[3])
PlantWhenAvailable(5,150,(3,8))
Prejudge(1,12)
WriteZombies([4],[1])
...
PlantWhenAvailable(5,150,(2,9))
Prejudge(1,17)
WriteZombies([4,3],[3,4])
Prejudge(1,18)
WriteZombies([2,3,3],[5,4,4])
PlantWhenAvailable(5,150,(5,9))
Prejudge(1,19)
WriteZombies([2,2,2,0],[4,4,4,4])
Prejudge(1,20)
WriteZombies([0,0,0,0,0,0,0,0,1,2,2,3,3],[1,2,3,1,2,3,1,2,3,1,2,3,1])
use_shovel((2,9))
Prejudge(250,20)
Card(3,(2,9))
while(game_ui() == 3):
