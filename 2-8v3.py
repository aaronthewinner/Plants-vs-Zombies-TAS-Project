...
SetGraves([(2,9),(5,9),(5,8),(3,9),(3,8),(3,7),(3,6)])
...
Prejudge(0,4)
WriteZombies([0,0],[1,3],[0.23,0.33])
...
Prejudge(1,10)
WriteZombies([0,0,0,0,1,2,8],[3,3,3,3,3,3,3],[0.37,0.37,0.37,0.37,0.37,0.45,0.5])
