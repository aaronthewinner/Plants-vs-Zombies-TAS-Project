...
while(read_memory("int", 0x6A9EC0, 0x768,0x144,0xC) != 0):
    Sleep(0.1)
select_all_seeds([9,8,24,16,17,4,12,15])
...
waves[950:962] = [0,0,0,0,0,0,0,1,2,4,16,18,-1]
waves = tuple(waves)
while(game_ui() != 3):
    Sleep(1)
update_game_scene()
...
Prejudge(1,20)
WriteZombies([0,0,0,0,0,0,0,1,2,4,16,18],[1,2,3,4,5,6,1,2,3,4,6,5],[0.37,0.37,0.37,0.37,0.37,0.37,0.37,0.45,0.37,0.37,0.37,0.45])
