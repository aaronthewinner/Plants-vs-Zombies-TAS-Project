...
waves[450:457] = [0,0,0,0,1,2,18,-1]
waves = tuple(waves)
while(game_ui() != 3):
    Sleep(1)
update_game_scene()
...
Prejudge(0,5)
WriteZombies([0,0],[1,2],[0.37,0.23])
PlantWhenAvailable(2,0,(1,6))

Prejudge(0,6)
WriteZombies([18],[1])
PlantWhenAvailable(7,25,(1,4))
...
Prejudge(0,9)
WriteZombies([0,0,0],[1,1,1])

Prejudge(1,10)
WriteZombies([0,0,0,0,1,2,18],[1,2,3,4,5,5,1])
