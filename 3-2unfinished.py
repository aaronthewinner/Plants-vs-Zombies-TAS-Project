...
update_game_scene()
Sleep(350)
select_seeds_and_lets_rock((0,1,2,4,6,3,16,17))
...
waves[600:603] = [4,0,-1]
waves[650:653] = [4,0,-1]
waves[700:704] = [2,0,3,-1]
waves[750:753] = [4,2,-1]
waves[800:803] = [4,3,-1]
waves[850:854] = [2,3,3,-1]
...
PlantWhenAvailable(8,50,(2,9))
PlantWhenAvailable(2,50,(1,5))
PlantWhenAvailable(2,50,(1,6))
Prejudge(1,2)
WriteZombies([0],[6])
...
PlantWhenAvailable(2,50,(1,7))
Prejudge(1,4)
WriteZombies([0,0],[1,6])
use_shovel(2,6)
PlantWhenAvailable(2,50,(1,8))
Prejudge(1,5)
WriteZombies([2],[5])
PlantWhenAvailable(8,50,(1,9))
Prejudge(1,6)
WriteZombies([2],[2])
PlantWhenAvailable(5,150,(2,9))
PlantWhenAvailable(2,50,(5,1))
Prejudge(1,7)
WriteZombies([0,2],[5,5])
PlantWhenAvailable(2,50,(5,2))
Prejudge(1,8)
WriteZombies([0,2],[2,5])
PlantWhenAvailable(5,150,(5,9))
PlantWhenAvailable(4,25,(1,9))
Prejudge(1,9)
WriteZombies([0,2],[1,1])
PlantWhenAvailable(2,50,(5,3))
PlantWhenAvailable(2,50,(5,4))
Prejudge(1,10)
WriteZombies([0,0,0,0,0,1,4],[4,4,4,4,4,6,6])
Prejudge(1,11)
WriteZombies([4],[5])
PlantWhenAvailable(5,150,(5,8))
Prejudge(1,12)
WriteZombies([4],[1])
PlantWhenAvailable(4,25,(6,9))
Prejudge(1,13)
WriteZombies([4,0],[2,4])
Prejudge(1,14)
WriteZombies([4,0],[1,4])
PlantWhenAvailable(5,150,(1,9))
Prejudge(1,15)
WriteZombies([2,0,3],[6,6,4])
PlantWhenAvailable(6,150,(4,1))
Prejudge(1,16)
WriteZombies([4,2],[2,4])
use_shovel((2,9))
PlantWhenAvailable(5,150,(2,9))
Prejudge(1,17)
WriteZombies([4,3],[5,4])
Prejudge(1,18)
WriteZombies([2,3,3],[6,4,4])
PlantWhenAvailable(5,150,(6,9))
Prejudge(1,19)
WriteZombies([2,2,2,0],[4,4,4,4])
Prejudge(1,20)
WriteZombies([0,0,0,0,0,0,0,0,1,2,2,3,3],[1,2,5,1,2,5,1,2,5,1,2,5,1])
use_shovel((2,9))
Prejudge(250,20)
Card(3,(2,9))
while(game_ui() == 3):
