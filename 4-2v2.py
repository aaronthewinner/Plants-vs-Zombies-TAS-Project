...
waves[900:901] = [7,-1]
waves[950:961] = [0,0,0,0,0,0,0,1,2,7,15,-1]
...
Prejudge(0,19)
WriteZombies([7],[6],[0.68])
use_shovel(3,9)

Prejudge(1,20)
WriteZombies([0,0,0,0,0,0,0,1,2,7,15],[1,2,3,4,5,6,1,3,4,2,5],[0.37,0.37,0.37,0.37,0.37,0.37,0.37,0.45,0.37,0.68,0.68])
