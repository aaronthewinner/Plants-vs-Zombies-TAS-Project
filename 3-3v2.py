...
update_game_scene()
Sleep(335)
select_seeds_and_lets_rock((1,16,17,4,6,8,2,3))
...
waves[800:803] = [0,2,11,-1]
waves[850:855] = [0,0,0,0,2,-1]
...
Prejudge(1,9)
WriteZombies([0,2],[5,5])
PlantWhenAvailable(6,0,(6,1))
use_shovel(5,9)
Delay(100)
PlantWhenAvailable(7,150,(5,9))
PlantWhenAvailable(1,50,(5,3))
PlantWhenAvailable(3,50,(6,9))

Prejudge(1,10)
WriteZombies([0,0,0,0,0,0,0,1,2],[6,6,6,6,6,6,6,6,6])

Prejudge(1,11)
WriteZombies([0,11],[6,3])
...
Prejudge(1,13)
WriteZombies([0,2,2],[4,4,1])
PlantWhenAvailable(5,150,(1,9))

Prejudge(1,14)
WriteZombies([0,2,2],[2,2,1])
use_shovel(1,9)
PlantWhenAvailable(5,150,(1,9))
Delay(120)
use_shovel(2,9)
...
Prejudge(1,17)
WriteZombies([0,2,11],[2,1,4])
PlantWhenAvailable(4,25,(6,9))

Prejudge(1,18)
WriteZombies([0,0,0,0,2],[2,2,2,2,5])
use_shovel(5,9)
PlantWhenAvailable(5,150,(5,9))

Prejudge(1,19)
WriteZombies([0,2,2,2],[6,6,6,6])
PlantWhenAvailable(2,25,(4,5))
PlantWhenAvailable(3,50,(4,5))

Prejudge(1,20)
WriteZombies([0,0,0,0,0,0,0,1,2,11],[2,3,4,2,3,4,2,3,4,3])
